...
# ---------------------------------------------------------------------
# Mount data directory (for serving assembled mp3/txt) BEFORE mounting root static
# Use cwd-based data dir (created earlier)
...
# --- Static mount for site root (mount AFTER ws routers) ---
CANDIDATES = [
...
if STATIC_ROOT and STATIC_ROOT.exists():
    # Mount root static after WS routers to avoid StaticFiles receiving websocket scopes.
